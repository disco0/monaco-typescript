	...
	getDefaultLibFileName(options: ts.CompilerOptions): string {
		switch (options.target) {
			case 99 /* ESNext */:
				...
				if (esnext in this._extraLibs) return esnext
			case 7 /* ES2020 */:
			case 6 /* ES2019 */:
			case 5 /* ES2018 */:
			case 4 /* ES2017 */:
			...
			default:
				...
				// Note: This looks in _extraLibs, not in the libFileMap
				// because they are not distributed with monaco-typescript. If you want
				// to add support for additional target options, you will need to
				// add the extra dts files to _extraLibs via the API.
				if (eslib in this._extraLibs) return eslib
